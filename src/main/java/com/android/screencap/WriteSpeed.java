...
class WriteSpeed {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ImageIO.write(rawImage, "png", new File(baseFolder, "try_r.png"));
        long tp2 = System.currentTimeMillis();
        ImageIO.write(pngImage, "png", new File(baseFolder, "try_p.png"));
        long tp3 = System.currentTimeMillis();
        log.info("Raw writes to png within: {}ms", tp2 - tp1);
        log.info("PNG writes to png within: {}ms", tp3 - tp2);
    }

    public static class WriteDiff {
        final ChancelDiff mAlpha;
        final ChancelDiff mRed;
        final ChancelDiff mGreen;
        final ChancelDiff mBlue;

        private WriteDiff(File folder, int width, int height) throws IOException {
